...
namespace FlowSdk::FlowMeasure {
    ConcreteAirportFilter::ConcreteAirportFilter(std::set<std::string> airportStrings)
        : airportStrings(std::move(airportStrings))
    {}
    ...
    {
        return std::find_if(airportStrings.begin(), airportStrings.end(),
