...
namespace FlowSdkTest::FlowMeasure {
    ...
    {
        public:
        ConcreteAirportFilterTest() : airportFilter(std::set<std::string>{"EGKK", "LF", "EDD", "K"})
        {}
    ...
    {
        public:
        ConcreteAirportFilterApplicabilityTest() : airportFilter(std::set<std::string>{"EGKK", "LF", "EDD", "K"})
        {}
    ...
    INSTANTIATE_TEST_SUITE_P(
            ...
            testing::Values(AirportFilterCheck{"EGKK", true}, AirportFilterCheck{"LFPG", true},
                            AirportFilterCheck{"LFP", true}, AirportFilterCheck{"LF", true},
                            AirportFilterCheck{"EDDM", true}, AirportFilterCheck{"EDDF", true},
                            AirportFilterCheck{"K", true}, AirportFilterCheck{"KJ", true},
                            AirportFilterCheck{"KJF", true}, AirportFilterCheck{"KJFK", true},
                            AirportFilterCheck{"EGLL", false}, AirportFilterCheck{"EGG", false},
                            AirportFilterCheck{"EG", false}, AirportFilterCheck{"E", false},
