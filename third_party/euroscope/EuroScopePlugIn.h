...
namespace EuroScopePlugIn {
    ...
    class DllSpecEuroScope CRadarScreen
    {
        ...
        void StartTagFunction(
                const char* sCallsign, const char* sItemPlugInName, int ItemCode, const char* sItemString,
        ...
        inline virtual void OnFlightPlanFlightStripPushed(
                CFlightPlan FlightPlan, const char* sSenderController, const char* sTargetController
        ){};
        //------------------------------------------------------------------
        //  Parameters :
        ...
        inline virtual void
        OnButtonDownScreenObject(int ObjectType, const char* sObjectId, POINT Pt, RECT Area, int Button){};
        //------------------------------------------------------------------
        //  Parameters :
        //      =>  ObjectType  - the type of the screen object
        //      =>  sObjectId   - the ID of the screen object
        ...
        inline virtual void
        OnButtonUpScreenObject(int ObjectType, const char* sObjectId, POINT Pt, RECT Area, int Button){};
        //------------------------------------------------------------------
        //  Parameters :
        //      =>  ObjectType  - the type of the screen object
        //      =>  sObjectId   - the ID of the screen object
        ...
        inline virtual void
        OnClickScreenObject(int ObjectType, const char* sObjectId, POINT Pt, RECT Area, int Button){};
        //------------------------------------------------------------------
        //  Parameters :
        //      =>  ObjectType  - the type of the screen object
        //      =>  sObjectId   - the ID of the screen object
        ...
        inline virtual void
        OnDoubleClickScreenObject(int ObjectType, const char* sObjectId, POINT Pt, RECT Area, int Button){};
        //------------------------------------------------------------------
        //  Parameters :
        //      =>  ObjectType  - the type of the screen object
        //      =>  sObjectId   - the ID of the screen object
        ...
        inline virtual void
        OnMoveScreenObject(int ObjectType, const char* sObjectId, POINT Pt, RECT Area, bool Released){};
        //------------------------------------------------------------------
        //  Parameters :
        //      =>  ObjectType  - the type of the screen object
        //      =>  sObjectId   - the ID of the screen object
    ...
    class DllSpecEuroScope CFlightPlanList
    {
        ...
        void AddColumnDefinition(
                const char* sColumnTitle, int Width, bool Centered, const char* sItemProvifer, int ItemCode,
    ...
    class DllSpecEuroScope CPlugIn
    {
        ...
        inline virtual void
        OnPlaneInformationUpdate(const char* sCallsign, const char* sLivery, const char* sPlaneType){};
        //-----------------------------------------------------------------
        //  Parameters :
        ...
        inline virtual void
        OnCompileFrequencyChat(const char* sSenderCallsign, double Frequency, const char* sChatMessage){};
        //------------------------------------------------------------------
        //  Parameters :
        ...
        inline virtual void
        OnCompilePrivateChat(const char* sSenderCallsign, const char* sReceiverCallsign, const char* sChatMessage){};
        //------------------------------------------------------------------
        //  Parameters :
        //      =>  sSenderCallsign - the sender
        ...
        inline virtual void OnGetTagItem(
                CFlightPlan FlightPlan, CRadarTarget RadarTarget, int ItemCode, int TagData, char sItemString[16],
        ...
        void AddPopupListElement(
                const char* sString1, const char* sString2, int FunctionId, bool Selected = false,
        ...
        void DisplayUserMessage(
                const char* sHandlerName, const char* sSenderName, const char* sMessage, bool ShowHandler,
